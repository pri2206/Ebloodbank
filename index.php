...
<div class="header">
 ...
 <div >
             <form class="searchbox" action="profile1.php" method=""> 
   ...
   <div class="container">
        <div class="innersection2">
            <div class="left-section2">
                 <h2>Helps when You Need Blood</h2>
 <p><i>Whenever wherever you need blood for yourself, your people or for humanity. We at eBloodBank tirelessly work 24x7 to support your effort.</i></p>
            </div>
 
               <div class="gif">

<img src="images/blood_orig[1].gif"  alt="eBloodBank">
            </div>
        </div>
   </div>
 </div>1
